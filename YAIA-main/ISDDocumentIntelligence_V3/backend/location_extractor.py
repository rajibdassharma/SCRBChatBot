...
# ---------------------------------------------------------------------------
def store_locations(
    doc_id: str, doc_name: str, locations: List[Dict[str, Any]]
) -> Dict[str, Any]:
...
def extract_and_store_locations(
    doc_id: str, doc_name: str, chunks: List[str]
) -> Dict[str, Any]:
    ...
    return store_locations(doc_id, doc_name, unique)
...
def get_extracted_doc_ids_for_locations() -> set:
...
def clear_locations_data() -> Dict[str, Any]:
