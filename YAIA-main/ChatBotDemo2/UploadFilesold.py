...
from secret_key import OPENAI_API_KEY, HUGGINGFACE_API_KEY
...
def create_langchain_chain():
        ...
        langchain_model = ChatOpenAI(temperature=0.0,model_name=AI_MODEL_NAME, openai_api_key=OPENAI_API_KEY)
