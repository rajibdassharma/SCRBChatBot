...
with tab3:
    ...
    if btn_flow or btn_accounts:
        if not crime_no.strip():
            ...
            <div id="viz" style="width:100%; height:650px; background:#fff; border:2px solid #ddd;"></div>
            ...
            (function () {{
                ...
                try {{
                    ...
                    // Force DB color if present (most reliable)
                    if (p.color) {{
                        nodes[i].color = {{
                        background: p.color,
                        border: "#333"
            ...
            # IMPORTANT: components.html must be imported earlier:
            # import streamlit.components.v1 as components
