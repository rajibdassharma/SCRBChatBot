...
class MoneyTransfer(Base):
    ...
    dest_account_no = Column(String(100), nullable=True)
    ifsc_code = Column(String(20), nullable=True)
    transaction_date = Column(String(50), nullable=True)
    dest_transaction_id = Column(String(100), nullable=True)
    ...
    report = relationship("MuleReport", back_populates="money_transfers")
